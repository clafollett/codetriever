...
fn test_concurrent_search_load() -> test_utils::TestResult {
...
#[test]
#[allow(clippy::significant_drop_tightening)] // test_state must live until cleanup
fn test_sustained_load_over_time() -> test_utils::TestResult {
    test_utils::get_test_runtime().block_on(async {
...
#[test]
#[allow(clippy::significant_drop_tightening)] // test_state must live until cleanup
fn test_memory_usage_under_load() -> test_utils::TestResult {
    test_utils::get_test_runtime().block_on(async {
